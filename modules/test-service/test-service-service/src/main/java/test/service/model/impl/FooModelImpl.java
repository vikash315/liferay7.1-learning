...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(test.service.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.test.service.model.Foo"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(test.service.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.test.service.model.Foo"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(test.service.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.test.service.model.Foo"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(test.service.service.util.ServiceProps.get(
				"lock.expiration.time.test.service.model.Foo"));
	...
	public String toXmlString() {
		...
		sb.append("test.service.model.Foo");
